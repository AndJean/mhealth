...
function ProfilePic(){
  ...
  return (
    <View style={{height:140, width:140, borderRadius:100, backgroundColor: color.input}}>
        ...
        <TouchableOpacity onPress={()=> openGallery()} style={{position: 'absolute', bottom: 0, right: 0, borderRadius: 10, paddingHorizontal:7, paddingVertical:7, backgroundColor: color.base}} >
